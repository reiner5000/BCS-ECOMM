// JavaScript Document
	$(window).on('load', function() {
		...
		$("#loader-wrapper").delay(100).fadeOut("fast", function() {
			$(".nav-item.nl-simple").css("display", "block");
		});
	...
	$(document).ready(function() {
		...
		$('#reviews-2 .center').slick({
			...
			responsive: [
				...
				},
				{
					breakpoint: 800,
					settings: {
						arrows: true, // Enable arrows for smaller breakpoints as well
						centerMode: true,
						centerPadding: '0px',
						slidesToShow: 1
					}
		...
		const productCarousel = document.querySelectorAll('.product-image-carousel');
		...
		function updateButtonStyles() {
			const prevButton = document.querySelectorAll(".slick-prev");
			const nextButton = document.querySelectorAll(".slick-next");
		...
		$('#reviews-1 .center').on('breakpoint', function(event, slick, breakpoint) {
				updateButtonStyles();
		});

		$('#reviews-2 .center').on('breakpoint', function(event, slick, breakpoint) {
			updateButtonStyles();
		});
		...
		$('.screens-carousel').on('breakpoint', function(event, slick, breakpoint) {
			updateButtonStyles();
		});
